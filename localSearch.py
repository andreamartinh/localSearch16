...
def localSearch(women, men, iterations,dfMen,dfWomen,alpha_cut):
    ...
    for k in range(iterations):
        ...
        alphas.append(globalAlpha)
        
        allGlobalAlphas.append(globalAlpha)
        # 1) Get Randon matching
    ...
    timeFound = end - start
    return  globalAlphas, globalAlpha, globalMatch, timeFound, k, allGlobalAlphas, alphas
...
for i in range(n,m):
    ...
    for j in range(5):
        ...
        k = 30
        globalAlphas, globalAlpha, globalMatch, timeFound, k,  allGlobalAlphas, alphas  = localSearch(women, men, p ,df_men, df_women,alpha_cut)
...
resulstAll_alphas = pd.DataFrame(all_alphas)
...
resulstAll_alphas.to_pickle("data/localSearch/Results/AllAlphas/"+  fileName +".pkl",protocol=2)
